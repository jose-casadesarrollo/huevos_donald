...
import { activateAgentConfigVersion, saveAgentConfig } from '@/app/admin/agente/actions'

import { Hint, Section, useSave } from './settings/_shared'
...
export function AgentConfigView({
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-4 px-5 pb-12 pt-4">
      <Toast.Provider />
